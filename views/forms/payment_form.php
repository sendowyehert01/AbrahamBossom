...
<div class="container-fluid">
    <div class="container">
        ...
        <hr class="custom-hr">
        <p class="text-center form-subtitle mb-4 mt-5">Send us your proof of payment and we will get back to you as soon
            as possible.</p>

        <!-- <form id="paymentForm" class="needs-validation" action="/payment" method="POST" novalidate> -->
        <form id="paymentForm" class="needs-validation" action="/payment" method="POST" enctype="multipart/form-data" novalidate>
            ...
            <div class="row">
                    ...
                    <div class="mb-3">
                        ...
                        <?php if (isset($transaction['firstName']) && isset($transaction['lastName'])) : ?>
                            <input type="text" class="form-control" id="fullName" placeholder="Enter your name"
                                name="fullName"
                                value="<?= ($transaction['firstName'] . ' ' . $transaction['middle'] . ' ' . $transaction['lastName']) ?? null ?>"
                                required>
                        <?php else : ?>
                            <input type="text" class="form-control" id="fullName" placeholder="Enter your name"
                    ...
                    <div class="mb-3">
                        ...
                        <?php if (isset($transaction['email'])) : ?>
                            <input type="email" class="form-control" id="email" placeholder="Enter your email" name="email"
                                value="<?= $transaction['email'] ?? null ?>" required>
                        <?php else : ?>
                            <input type="email" class="form-control" id="email" placeholder="Enter your email" name="email"
                                required>
                        <?php endif; ?>
                ...
                <div class="col-lg-6 col-sm-12">
                    <div class="mb-3">
                        ...
                        <?php if (isset($transaction['contactNo'])) : ?>
                            <input type="tel" class="form-control" id="contact" placeholder="+639" name="contactNo"
                                value="<?= $transaction['contactNo'] ?? null ?>" required>
                        <?php else : ?>
                            <input type="tel" class="form-control" id="contact" placeholder="+639" name="contactNo"
                                required>
                        <?php endif; ?>
                ...
                <div class="col-lg-6 col-sm-12">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="modeOfPayment" name="mop"
                ...
                <div class="col-lg-6 col-sm-12">
                    <div class="mb-3">
                        <label for="productService" class="form-label">Product/Service <span
                                class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="productService" name="selectedService"
                    ...
                    <div class="mb-3">
                        ...
                        <?php if (isset($transaction['refId'])) : ?>
                            <input type="text" class="form-control" id="referenceNo" placeholder="Enter reference number"
                                name="refId" value="<?= $transaction['refId'] ?? null ?>" required>
                        <?php else : ?>
                            <input type="text" class="form-control" id="referenceNo" placeholder="Enter reference number"
                                name="refId" required>
                        <?php endif; ?>
                ...
                <div class="col-lg-6">
                    <div class="mb-3">
                        <label for="proofOfPayment" class="form-label">Proof of Payment</label>
                        <input type="file" class="form-control" id="proofOfPayment" name="proof" accept="image/*" required>
                        <div class="invalid-feedback">Please upload a proof of payment</div>
                    </div>
                </div>
            </div>
