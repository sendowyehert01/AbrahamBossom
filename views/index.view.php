    ...
    <div class="card m-3">
        <div class="d-flex">
            ...
            <div class="card-body m-5">
              <h5 class="card-title">THE ABRAHAM’S BOSOM MEMORIAL GARDEN </h5>
              <p class="card-text">Abraham's Bosom Cemetery, established in Silang, Cavite sometime in the 1990, has become a cornerstone for the community. Its name evokes a sense of comfort, drawing inspiration from the Biblical parable where Abraham welcomes the righteous into paradise.</p>
              <a href="#" class="btn btn-success">READ MORE <i class="bi bi-arrow-right"></i></a>
            </div>
        </div>
    </div>
      ...
      <div id="owl-demo" class="owl-carousel owl-theme mb-3">
        <div class="container-sm p-5">
          <div class="card text-bg-dark">
            <img src="style/images/IMG_1402.PNG" class="card-img" alt="...">
